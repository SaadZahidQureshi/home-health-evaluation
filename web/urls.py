...
urlpatterns = [
    ...
    path("saved/", SavedgPageTemplateView.as_view(), name="saved_page"),
    ...
    path("keep-it-clean-item-selected/", KeepItCleanItemSelectedPageTemplateView.as_view(), name="keep_it_clean_item_selected_page"),
